...
export const agedWoClosureCandidates = pgTable(
  'aged_wo_closure_candidates',
  {
    ...
    woCreatedAt: timestamp('wo_created_at', { withTimezone: true }),
    woCompletedOn: timestamp('wo_completed_on', { withTimezone: true }),
    billInvoiceDate: timestamp('bill_invoice_date', { withTimezone: true }),
    billPaidAt: timestamp('bill_paid_at', { withTimezone: true }),
    billServiceFrom: timestamp('bill_service_from', { withTimezone: true }),
    billServiceTo: timestamp('bill_service_to', { withTimezone: true }),
    propertyAddress: text('property_address'),
  ...
  (table) => ({
    ...
    confidenceTierIdx: index('aged_wo_closure_candidates_confidence_tier_idx').on(table.confidenceTier),
    confidenceScoreIdx: index('aged_wo_closure_candidates_confidence_score_idx').on(table.confidenceScore),
  }),
);
